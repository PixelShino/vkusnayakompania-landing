...
(() => {
  ...
  class ImageSlot extends HTMLElement {
    ...
    _render() {
      ...
      // Mockup mode: attribution stays in the page source (credit /
      // credit-href attributes) but the on-image overlay is not drawn.
      const showCredit = false && !!(url && credit && !this._userUrl && !attrError);
